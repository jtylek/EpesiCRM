...
$form->addElement('button', 'submit_button', 'Uninstall Selected', array('class'=>'button', 'onclick'=>'if(confirm("Are you sure you want to uninstall selected modules?"))document.modulesform.submit();'));
