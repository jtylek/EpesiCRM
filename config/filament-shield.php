...
return [
    ...
    */
    ...
    |
    | 'generate' is off: shield:generate overwrites existing policies, and the
    | modules' policies are hand-written ownership rules, not stubs. It only
    | sets the default — `--option=policies` still generates on purpose.
    |
    */
