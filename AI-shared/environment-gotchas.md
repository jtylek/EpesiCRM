...
## `FORCE_CACHE_COMMON_FILES` — removed 2026-08-31

The common-class bundle this section used to document is gone. It was measured (worth
~3.5 ms/request with opcache, nothing without) against three real costs, including one
that broke this machine's webmail the same day it shipped. Full findings, the
measurement, and what to do if this is proposed again: `deliberate-removals.md`'s
