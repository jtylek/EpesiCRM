...
class CRM_TasksCommon extends ModuleCommon {
	...
	public static function bootstrap_icon() { return 'bi-list-task'; }
...
/*		$r_new = $r;
		...
		$edit_info = Utils_RecordBrowserCommon::get_record_info('task', $r['id']);
