...
class CRM_AssetsInstall extends ModuleInstall {
    ...
    public function install() {
        ...
        Utils_RecordBrowserCommon::set_icon('crm_assets', Base_ThemeCommon::get_template_filename(CRM_Assets::module_name(), 'icon.png'));
        ...
        Utils_RecordBrowserCommon::new_addon('company', CRM_Assets::module_name(), 'assets_addon', _M('Assets'));
    ...
    public function uninstall() {
        ...
        Utils_RecordBrowserCommon::delete_addon('company', CRM_Assets::module_name(), 'assets_addon');
