...
class CRM_RoundcubeInstall extends ModuleInstall {
	...
	Utils_RecordBrowserCommon::register_processing_callback('rc_accounts', array('CRM_RoundcubeCommon', 'submit_account'));
        ...
        Utils_RecordBrowserCommon::new_addon('rc_mail_threads', CRM_RoundcubeInstall::module_name(), 'thread_addon', _M('E-mails'));
		...
		Utils_RecordBrowserCommon::set_tpl('rc_mails', Base_ThemeCommon::get_template_filename(CRM_RoundcubeInstall::module_name(), 'mails'));
        ...
        Utils_RecordBrowserCommon::enable_watchdog('rc_mails', array('CRM_RoundcubeCommon', 'watchdog_label'));
		...
		Utils_RecordBrowserCommon::new_addon('rc_mails', CRM_RoundcubeInstall::module_name(), 'mail_body_addon', _M('Body'));
        Utils_RecordBrowserCommon::new_addon('rc_mails', CRM_RoundcubeInstall::module_name(), 'attachments_addon', _M('Attachments'));
		Utils_RecordBrowserCommon::new_addon('rc_mails', CRM_RoundcubeInstall::module_name(), 'mail_headers_addon', _M('Headers'));
        ...
        Utils_RecordBrowserCommon::new_addon('contact', CRM_RoundcubeInstall::module_name(), 'addon', _M('E-mails'));
        Utils_RecordBrowserCommon::new_addon('company', CRM_RoundcubeInstall::module_name(), 'addon', _M('E-mails'));
		...
		Utils_RecordBrowserCommon::set_icon('rc_multiple_emails', Base_ThemeCommon::get_template_filename(CRM_RoundcubeInstall::module_name(), 'icon.png'));
        Utils_RecordBrowserCommon::set_search('rc_multiple_emails',2,0);

		Utils_RecordBrowserCommon::new_addon('contact', CRM_RoundcubeInstall::module_name(), 'mail_addresses_addon', _M('E-mail addresses'));
		Utils_RecordBrowserCommon::new_addon('company', CRM_RoundcubeInstall::module_name(), 'mail_addresses_addon', _M('E-mail addresses'));
