...
$rcmail_config['imap_ns_personal'] = ($account['f_imap_root']?$account['f_imap_root']:null);
...
$rcmail_config['smtp_server'] = ($account['f_smtp_security']?$account['f_smtp_security'].'://':'').$account['f_smtp_server'];

// SMTP port (default is 25; 465 for SSL)
$rcmail_config['smtp_port'] = $account['f_smtp_security']=='ssl'?465:25;

// SMTP username (if required) if you use %u as the username RoundCube
// will use the current username for login
$rcmail_config['smtp_user'] = $account['f_smtp_auth']?$account['f_smtp_login']:'';

// SMTP password (if required) if you use %p as the password RoundCube
// will use the current user's password for login
$rcmail_config['smtp_pass'] = $account['f_smtp_auth']?$account['f_smtp_password']:'';
...
$rcmail_config['log_dir'] = $log_dir;

// use this folder to store temp files (must be writeable for apache user)
$rcmail_config['temp_dir'] = $data_dir;
...
$rcmail_config['des_key'] = 'g&-tSf==?2D7xsy%R?pcgwaE';
...
$rcmail_config['addressbook_search_mods'] = null;  // Example: array('*' => array('subject'=>1, 'from'=>1), 'Sent' => array('subject'=>1, 'to'=>1));
