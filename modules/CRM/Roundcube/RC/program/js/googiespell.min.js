...
function GoogieSpell(u,v,w){var m=this,t=rcmail.get_cookie("language");GOOGIE_CUR_LANG=null!=t?t:GOOGIE_DEFAULT_LANG;this.array_keys=function(a){var b=[],c;for(c in a)b.push([c]);return b};this.img_dir=u;this.server_url=v;this.lang_to_word=this.org_lang_to_word={da:"Dansk",de:"Deutsch",en:"English",es:"Espa\u00f1ol",fr:"Fran\u00e7ais",it:"Italiano",nl:"Nederlands",pl:"Polski",pt:"Portugu\u00eas",ru:"\u0420\u0443\u0441\u0441\u043a\u0438\u0439",fi:"Suomi",sv:"Svenska"};this.langlist_codes=this.array_keys(this.lang_to_word);
...
!0;this.custom_no_spelling_error=this.custom_ajax_error=null;this.custom_menu_builder=[];this.custom_item_evaulator=null;this.extra_menu_items=[];this.custom_spellcheck_starter=null;this.main_controller=!0;this.has_dictionary=w;this.all_errors_fixed_observer=this.show_menu_observer=this.spelling_state_observer=this.lang_state_observer=null;this.use_focus=!1;this.focus_link_b=this.focus_link_t=null;this.cnt_errors_fixed=this.cnt_errors=0;$(document).click(function(a){a=$(a.target);"1"!=a.attr("googie_action_btn")&&
...
$(l).attr("googie_action_btn","1").css({margin:0,padding:0,cursor:"default","white-space":"nowrap"}).submit(n);l.appendChild(p);l.appendChild(h);f.appendChild(l);k.appendChild(f);g.appendChild(k);0<this.extra_menu_items.length&&g.appendChild(this.createListSeparator());var s=function(b){if(b<c.extra_menu_items.length){var d=c.extra_menu_items[b];if(!d[2]||d[2](a,c)){var e=document.createElement("tr"),f=document.createElement("td");$(f).html(d[0]).mouseover(c.item_onmouseover).mouseout(c.item_onmouseout).click(function(){return d[1](a,
c)});e.appendChild(f);g.appendChild(e)}s(b+1)}};s(0);s=null;this.use_close_btn&&g.appendChild(this.createCloseButton(this.hideErrorWindow))}e.appendChild(g);this.error_window.appendChild(e);f=$(this.error_window).height();e=$(this.error_window).width();h=$(document).height();k=$(document).width();f=d.top+f+20<h?d.top+20:d.top-f;d=d.left+e<k?d.left:d.left-e;$(this.error_window).css({top:f+"px",left:d+"px"}).show();document.all&&!window.opera&&(this.error_window_iframe||(d=$("<iframe>").css({position:"absolute",
