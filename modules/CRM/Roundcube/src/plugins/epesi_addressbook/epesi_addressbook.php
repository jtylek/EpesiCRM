...
class epesi_addressbook extends rcube_plugin
{
  ...
  {
    $p['sources'][$this->abook_id] = array('id' => $this->abook_id, 'name' => 'Epesi', 'readonly' => true);
    return $p;
  }
  ...
  public function get_address_book($p)
  {
    if ($p['id'] == $this->abook_id) {
      require_once(dirname(__FILE__) . '/epesi_addressbook_backend.php');
      $p['instance'] = new epesi_addressbook_backend;
    }
