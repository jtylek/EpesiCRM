...
$html = '<html>'.
        ...
        '<script type="text/javascript">function fix_height(){parent.document.getElementById("rc_mail_body").height = Math.max(document.body.offsetHeight,document.body.scrollHeight)+30;}</script>'.
