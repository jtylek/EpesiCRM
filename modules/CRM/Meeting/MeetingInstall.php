...
class CRM_MeetingInstall extends ModuleInstall {
	...
	public function install() {
		...
		$fields = array(
			...
			array('name'=>'Date', 				'type'=>'date', 'extra'=>false, 'param'=>'255', 'visible'=>false),
			array('name'=>'Time', 				'type'=>'time', 'extra'=>false, 'param'=>'255', 'visible'=>false),
			...
			array('name'=>'Recurrence type',	'type'=>'integer', 'required'=>false, 'visible'=>true, 'extra'=>false, 'visible'=>true, 'QFfield_callback'=>array('CRM_MeetingCommon','QFfield_recurrence')),
			array('name'=>'Recurrence end', 	'type'=>'date', 'required'=>false, 'visible'=>true, 'extra'=>false, 'QFfield_callback'=>array('CRM_MeetingCommon','QFfield_recurrence_end')),
