	...
	public function get_navigation_bar_additions() {
		...
		eval_js('hide_calendar_event_handlers_popup = function() {'.
			'if(var_hide_calendar_event_handlers_popup==1){'.
				'document.getElementById("calendar_event_handlers_popup").style.display="none";'.
				'document.getElementById("calendar_event_handlers_trigger").innerHTML=calendar_event_handlers_message_default;'.
				'if(calendar_event_handlers_changed==1){'.
					$form->get_submit_form_js().
					'document.getElementById("calendar_event_handlers_trigger").innerHTML=calendar_event_handlers_message_processing;'.
				'}'.
			'}'.
		'}');
		eval_js('show_calendar_event_handlers_popup = function() {'.
			'document.getElementById("calendar_event_handlers_popup").style.display="";'.
			'document.getElementById("calendar_event_handlers_trigger").innerHTML=calendar_event_handlers_message_confirm;'.
		'}');
