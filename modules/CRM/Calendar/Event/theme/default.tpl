...
<div style="background-color: white; padding: 5px;">
    ...
    <table name="CRMCalendar" class="form no-border" cellspacing="0" cellpadding="0" border="0">
        <tbody>
			...
			<tr>
			 	<td class="data" style="border-right: 1px solid #b3b3b3;"><span class="error">{$form_data.date_s.error}</span><div style="float: left">{$form_data.date_s.html}</div><span id="time_s">{$form_data.time_s.html}</span></td>
			 	<td class="data">
					...
					<div id="{$event_end_block_id}"><span class="error">{$form_data.date_e.error}</span><div style="float: left">{$form_data.date_e.html}</div><span id="time_e">{$form_data.time_e.html}</span></div>
				</td>
            </tr>
            <tr>
