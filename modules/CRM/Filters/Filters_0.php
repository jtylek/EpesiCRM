...
class CRM_Filters extends Module {
	...
	public function body() {
		...
		print('<a class="lbOn'.($in_use?'':' disabled').' button" rel="crm_filters">'.__('Perspective').': '.'<b>'.$_SESSION['client']['filter_'.Acl::get_user()]['desc'].'</b><i class="fa fa-user fa-lg" style="margin-left: 10px"></i></a>');
	}
