...
// ************ phone calls ************** //
		Base_ThemeCommon::install_default_theme(CRM_PhoneCall::module_name());
		$fields = array(
		...
		Utils_RecordBrowserCommon::set_tpl('phonecall', Base_ThemeCommon::get_template_filename(CRM_PhoneCall::module_name(), 'default'));
		Utils_RecordBrowserCommon::register_processing_callback('phonecall', array('CRM_PhoneCallCommon', 'submit_phonecall'));
		Utils_RecordBrowserCommon::set_icon('phonecall', Base_ThemeCommon::get_template_filename(CRM_PhoneCall::module_name(), 'icon.png'));
...
// ************ addons ************** //
		...
		Utils_RecordBrowserCommon::new_addon('phonecall', CRM_PhoneCall::module_name(), 'messanger_addon', _M('Alerts'));
...
// ************ other ************** //
	...
	public function uninstall() {
		...
		Base_ThemeCommon::uninstall_default_theme(CRM_PhoneCall::module_name());
