{* CRM_PhoneCall registers this as the per-table template for the
   ...
   longfields) kept byte-for-byte identical to the default theme's own
   default.tpl - real per-field layout, not decoration. id="CRM_PhoneCall" is
   kept on the wrapper (unlike Contact.tpl, this module's own default theme
   CSS - modules/CRM/PhoneCall/theme/default.css - scopes status/priority/
