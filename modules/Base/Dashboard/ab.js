dashboard_activate = function(default_dash) {
	...
	for(var id=0; id<3; id++)
		Sortable.create("dashboard_applets_"+id,{dropOnEmpty:true,tag:'div',containment:["dashboard_applets_0","dashboard_applets_1","dashboard_applets_2"],constraint:false, handle: 'handle',onUpdate:function(c){
