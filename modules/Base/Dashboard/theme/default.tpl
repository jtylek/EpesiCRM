    ...
    <tr>
        ...
        <td colspan="3" rowspan="3" class="center-center">
            ...
            <table class="container" cellpadding="0" cellspacing="0" border="0">
            	...
            	<td class="header controls">{$__link.toggle.open}<img src="{$theme_dir}/images/icons/small-icon-roll-up.png" onClick="var x='{$theme_dir}/images/icons/small-icon-roll-';if(this.src.indexOf(x+'down.png')>=0)this.src=x+'up.png';else this.src=x+'down.png';" minimized=0 width="14" height="14" alt="=" border="0">{$__link.toggle.close}
