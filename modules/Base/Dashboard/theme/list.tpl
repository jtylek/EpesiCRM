...
<table id="Base_Dashboard" cellspacing="0" cellpadding="0">
	<tr>
		<td colspan="4" class="header">{$header_in_use}</td>
	</tr>
	<tr>

	{assign var=x value=0}
	{foreach key=key item=button from=$buttons_in_use}
	{assign var=x value=$x+1}
...
<!-- -->
			...
			{$__link.buttons_in_use.$key.link.open}
			<div class="big-button">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td class="bb_icon" rowspan="2">
						...
						<td class="bb_text">
							{$__link.buttons_in_use.$key.link.text}
						</td>
					</tr>
					<tr>
						<td class="bb_desc">
			...
			{$__link.buttons_in_use.$key.link.close}
