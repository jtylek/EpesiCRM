...
class Base_EpesiStoreCommon extends Base_AdminModuleCommon {
	...
	public static function bootstrap_icon() { return 'bi-box-seam'; }
    ...
    public static function admin_caption() {
        return array('label' => __('Modules Administration & Store'), 'section' => __('Administration'));
    }
    ...
    public static function post_install_refresh_by_ajax() {
        ...
        $ajax_req = "jQuery.ajax('modules/Base/EpesiStore/runpatches.php',"
                . "{ method: 'post', dataType: 'text', "
                . "complete: function(jqXHR) {var t=jqXHR;Epesi.procOn--;"
