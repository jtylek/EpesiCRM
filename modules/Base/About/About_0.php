...
class Base_About extends Module {
	private function get_info() {
		return '<center>'.
			...
			'</li><li> <b>Saja</b> - Saja is a lightweight, open-source AJAX scripting engine for PHP4/5, with optional secured data transfer. It is designed for the speedy creation of simple, secure, and maintainable AJAX applications, without the need to write any JavaScript. MIT Licence - Copyright (c) Dave Maestri <a href="http://saja.sourceforge.net" title="http://saja.sourceforge.net" rel="nofollow">http://saja.sourceforge.net</a>'.
