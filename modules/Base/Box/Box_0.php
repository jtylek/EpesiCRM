...
//      $containers['main']['name'] .= '_'.$main_length;
		...
		if (SUGGEST_DONATION)
			$theme->assign('donate',Utils_TooltipCommon::create('<a target="_blank" href="http://www.epesibim.com/cost">'.$this->t('Support epesi!').'</a>', $this->t('<center>If you find our software useful, please support us by making a donation.<br>Your funding will help to ensure continued development of this project.<br>Click for details.</center>'), false, 500));
