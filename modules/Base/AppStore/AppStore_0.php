...
//        Variable::set("license_key", '');
        ...
        if (Base_AppStoreCommon::get_license_key() == "") {
            return $this->register();
        } else {
            echo Base_AppStoreCommon::get_license_key() . "<br/>";
            Base_AppStoreCommon::server()->set_client_license_key(Base_AppStoreCommon::get_license_key());
            echo Base_AppStoreCommon::server()->get_installation_status() . "<br/>";
        }
    ...
    public function register() {
        ...
        if ($f->validate()) {
            ...
            $lic = Base_AppStoreCommon::server()->register_client_id_request($ret);

            if ($lic) {
                Base_AppStoreCommon::set_license_key($lic);
