<table id="Base_User_Settings" cellspacing="5" cellpadding="0">
	<tr>
...
<table id="shadow" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <!-- -->
			...
			<div class="button">
				<img src="{$theme_dir}/{$button.icon}" border="0" width="32" height="32" align="middle">&nbsp;&nbsp;{$__link.buttons.$key.link.text}
			</div>
