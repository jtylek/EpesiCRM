...
<?php
	...
	$jses = array('modules/Base/MainModuleIndicator/help.js');
...
?>
		...
		<br>
		<center>
		<span class="footer">Copyright &copy; <?php echo date('Y'); ?> &bull; <a href="http://www.telaxus.com">Janusz Tylek</a></span>
		<br>
