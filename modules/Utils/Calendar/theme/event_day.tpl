...
{if $with_div}
<div id="utils_calendar_event:{$event_id}" style="display:none;" class="utils_calendar_event" onmouseover="this.oldZIndex=this.style.zIndex;this.style.zIndex=80;" onmouseout="this.style.zIndex=this.oldZIndex;">
{/if}
...
{else}
	                <span id="event_info"><img {$tip_tag_attrs} src="{$theme_dir}/Utils/Calendar/info.png" onClick="event_menu('{$event_id}')" width="28" height="28" border="0"></span>
{/if}
