...
{if $with_div}
<div id="utils_calendar_event:{$event_id}" style="width:83px; display:none;" class="utils_calendar_event" onmouseover="this.oldZIndex=this.style.zIndex;this.style.zIndex=80;" onmouseout="this.style.zIndex=this.oldZIndex;">
{/if}
