...
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES']['currency'] = Epesi\Module\Utils\CurrencyField\QuickForm\CurrencyElement::class;

on_init(['Utils_CurrencyFieldCommon','load_js']);
?>
