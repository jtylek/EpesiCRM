var Utils_CommonData = function(id,val,cd,ae,order) {
	this.obj = $(id);
...
Utils_CommonData.prototype.obj = null;
Utils_CommonData.prototype.path = null;
Utils_CommonData.prototype.add_empty = null;
Utils_CommonData.prototype.order = '';
Utils_CommonData.prototype.def_val = '';
Utils_CommonData.prototype.first_request = function(e) {
	Event.stopObserving(document,'e:load',this.first_request_bind);
//		alert('first');
	this.request(null);
};
Utils_CommonData.prototype.first_request_bind = null;
...
Utils_CommonData.prototype.on_request = function(t) {
