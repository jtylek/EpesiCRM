...
class Utils_FileUpload extends Module {
	...
	public function get_submit_form_js() {
		...
		$form_name = $this->form->getAttribute('name');
		return "if(Epesi.procOn>0)return false;Epesi.updateIndicatorText('".$this->t("uploading...")."');Epesi.procOn++;Epesi.updateIndicator();document.forms['".$this->form->getAttribute('name')."'].submit();";
	}
