...
if ($mode=='submit') {// && $form->validate()) {
	...
	print('document.getElementById("grid_value_field_'.$element.'_'.$id.'").innerHTML = \''.Epesi::escapeJS($html).'\';');
	return;
}
ob_start();
...
print('document.getElementById("grid_form_field_'.$element.'_'.$id.'").innerHTML = \''.Epesi::escapeJS($html).'\';');
