...
//                  $gb->set_module_variable('quickjump_to',null);
        ...
        if (!$pdf && !$special && $this->get_access('add',$this->custom_defaults)!==false) {
            ...
            if ($label!==false && $label!=='') $custom_label = '<a class="record_browser_add_new" '.$label.' '.Utils_TooltipCommon::open_tag_attrs($this->t('Add new record')).'><img src="'.Base_ThemeCommon::get_template_file('Utils/RecordBrowser/add.png').'" /><div class="add_new">Add new</div></a>';
