...
table_overflow_show = function (e_td, force) {
	...
	if (force || e_td.scrollHeight>e_td.clientHeight || e_td.scrollWidth>e_td.clientWidth) {
        ...
        while (e_td.childNodes.length>0) {
			document.getElementById("table_overflow_content").appendChild(e_td.firstChild);
		}
...
table_overflow_hide = function (current) {
	...
	if (utils_genericbrowser__last_td) {
		...
		while (document.getElementById("table_overflow_content").childNodes.length>0) {
			utils_genericbrowser__last_td.appendChild(document.getElementById("table_overflow_content").firstChild);
		}
