 ...
 * @access public
 */
class HTML_QuickForm_Renderer_TCMSArraySmarty extends HTML_QuickForm_Renderer_TCMSArray
{
   /**
    ...
    * @access public
    */
    function __construct(&$tpl=null, $staticLabels = false)
    {
