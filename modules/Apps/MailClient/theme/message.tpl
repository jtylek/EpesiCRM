						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr>
									...
									<td class="right"><a href=""><img src="{$theme_dir}/Libs/Leightbox/close.png" onMouseOver="this.src='{$theme_dir}/Libs/Leightbox/close-hover.png';" onMouseOut="this.src='{$theme_dir}/Libs/Leightbox/close.png';" width="14" height="14" alt="X" border="0" /></a></td>
								</tr>
							</tbody>
						</table>
					</div>
