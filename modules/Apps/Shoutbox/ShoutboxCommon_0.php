...
class Apps_ShoutboxCommon extends ModuleCommon {
	...
	public static function bootstrap_icon() { return 'bi-chat-square-text'; }
	...
	public static function create_write_to_link ($uid) {
		...
		if (Acl::get_user() != $uid) $ret = "<a href=\"javascript:void(0);\" onclick=\"autoselect_add_value('shoutbox_to', ".$uid.", '".Epesi::escapeJS($ret)."');autoselect_stop_searching('shoutbox_to');document.getElementById('shoutbox_to').onchange();\">".$ret.'</a>';
		return $ret;
	}
