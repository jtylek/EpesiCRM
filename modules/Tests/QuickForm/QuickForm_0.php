...
//		$f->freeze();
		...
		Utils_ChainedSelectCommon::create('sel2',array('sel1'),'modules/Tests/QuickForm/update_sel.php');
		Utils_ChainedSelectCommon::create('sel3',array('sel1','sel2',),'modules/Tests/QuickForm/update_sel.php');
